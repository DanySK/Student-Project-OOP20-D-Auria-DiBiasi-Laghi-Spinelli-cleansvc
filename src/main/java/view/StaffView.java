...
public class StaffView extends JFrame {
    ...
    public void updateSearchingCFs(JComboBox<String> staffCFs) {
        staffCFs.removeAllItems();
        for (Staff staff : company.getStaff()){
            staffCFs.addItem(staff.getCFPIVA());
        }
    }
    /**
     * 
